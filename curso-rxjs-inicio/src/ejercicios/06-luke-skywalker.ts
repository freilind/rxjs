...
/**
 * Ejercicio: 
 *  Realizar 2 peticiones HTTP (ajax) una despues de otra.
 *  
 *  La primera debe de obtener el personaje de Star Wars:
 *   Luke Skywalker, llamando el endpoint:   /people/1/
 * 
 *  La segunda peticion, debe de ser utilizando el objeto
 *  de la peticion anterior, y tomar la especie (species),
 *  que es un arreglo de URLs (array), dentro de ese arreglo, 
 *  tomar la primera posicion y realizar la llamada a ese URL,
 *  el cual deberi�a de traer informacion sobre su especie (Human)
 */

// Respuesta esperada:
// Informacion sobre los humanos en el universo de Star Wars
...
// Retornar el siguiente objeto con la informacion de ambas peticiones
// Recordando que se disparan una despues de la otra, 
// con el URL que viene dentro del arreglo de 'species'

// Tip: investigar sobre la funcion zip: 
...
(() =>{
    ...
    getRequest(`Aqui� va un URL`).pipe(
        // Realizar los operadores respectivos aqui
